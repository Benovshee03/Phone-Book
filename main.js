  ...
  try {
    ...
    data.forEach((e) => {
      ...
      trow.innerHTML = `
        ...
        <td>${e.number}</td>
        <td>${e.mail}</td>
        <td><button type="button" class="btn btn-danger times"><i class="fa-solid fa-xmark"></i></button>
        <button type="button" class="btn btn-warning update"><i class="fa-solid fa-pen"></i></button></td>
        `;
    ...
    searchInput.addEventListener("keyup", (e) => {
      ...
      const filteredData = data.filter((u) => {
        ...
        return (
          name.includes(val) ||
          surname.includes(val || mail.includes(val)) ||
